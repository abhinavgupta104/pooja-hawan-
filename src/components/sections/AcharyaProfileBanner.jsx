        ...
        <div className="acharya-inner" style={{
          ...
          <div style={{ flex: '1 1 300px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            <div style={{ 
              ...
              <img
                src="/images/pandits/photo.jpeg"
                alt={pandit.name}
                onError={e => {
                  e.currentTarget.onerror = null
                  e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(pandit.name)}&background=C9A84C&color=fff&size=240`
                }}
                style={{ width: '100%', height: '100%', borderRadius: '50%', objectFit: 'cover', border: '4px solid var(--bg-card)' }} />
            </div>
